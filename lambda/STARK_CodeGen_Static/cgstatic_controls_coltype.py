...
def create(data):
    ...
    if col_type == "date":
        ...
        #A group of check boxes for multiple choice inputs
            ...
            html_code=f"""<b-form-file v-model="STARK_upload_elements.{col_varname}.file" :placeholder="STARK_upload_elements.{col_varname}.file" drop-placeholder="Drop file here..." @input="s3upload('{col_varname}')" onmouseover="root.init_s3_access()" onfocus="root.init_s3_access()"></b-form-file>      
